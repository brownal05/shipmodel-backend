...
class ShipModelAPI:
    def perform_calculation(self, data):
        try:
            ...
            seca_bunker_loading = data['seca_bunker_loading']
            canal_cost = 0 if data['canal_cost'] == '' or data['canal_cost'] == None else data['canal_cost']
            other_income = 0 if data['other_income'] == '' or data['canal_cost'] == None else data['other_income']
